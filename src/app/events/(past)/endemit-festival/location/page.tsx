    ...
    <div className="m-auto max-w-5xl space-y-8 p-5 lg:px-12 text-black">
      ...
      <div className="space-y-6">
        <p className="text-xl leading-relaxed">
          ...
          . Turn right in front of the house toward the river, and look for the
          mark X.
        </p>
        ...
        <p className="text-xl leading-relaxed">
          The event kicks off at 18:00 on Friday. You&apos;ll have ample time to
      ...
      <div className="space-y-6">
        <h2 className="text-4xl font-bold uppercase mt-12">Accommodation</h2>

        <p className="text-xl leading-relaxed">
          There will be a camping area in a designated field, allowing everyone
          to find the perfect spot. Feel at home, but to maintain harmony with
          your neighbors, please respect the rules of nature and keep the area
          clean.
        </p>
        ...
        <p className="text-xl leading-relaxed">
          For camper vans, there&apos;s a designated parking area (with electric
          plugs) available on a first-come, first-served basis.
        </p>

        <p className="text-xl leading-relaxed">
          For those seeking more comfort, we recommend nearby accommodations
          such as Korošica Hotel, Ta Fabrika lodgings, Hostel Punkl, and more.
          Feel free to reach out if you need help finding the perfect spot.
        </p>

        <h2 className="text-4xl font-bold uppercase">Toilet and Showers</h2>

        <p className="text-xl leading-relaxed">
          Pleasant and clean restrooms and showers will provide comfortable and
          private facilities for personal hygiene. The structure is located by a
          stream, built from wood, and offers a completely different experience
          from what you&apos;re used to at similar events.
        </p>
        ...
        <p className="text-xl leading-relaxed">
          Let&apos;s practice water conservation when showering, ensuring that
          everyone can enjoy the facilities by being mindful of our usage.
        </p>
