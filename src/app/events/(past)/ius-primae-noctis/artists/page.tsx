          ...
          <div className="flex flex-col space-y-12">
            ...
            <div className="flex flex-col gap-8 md:flex-row">
              ...
              <div className="text-xl">
                ...
                his long-awaited debut in the castle cellar. Until now, his sets
                have always resonated under open skies, but now we&apos;re
                bringing his sound indoors, where stone walls will trap the
                pressure. Expect a time-warping clash: classic &apos;90s techno
                and gritty hard house face off against a darker, modern edge.
                Back to the future—under vaulted ceilings.
              </div>
            </div>
            ...
            <div className="flex flex-col gap-8 md:flex-row">
              ...
              <div className="text-xl">
                ...
                stepping behind the booth. Known for his deep dedication to the
                craft, he shapes his sound through analog and modular hypnotic
                rhythms, deep frequencies, and abstract textures. A true digger
                and sound explorer, he plays vinyl only—letting the rawness of
                wax guide the journey. Miha is ready to translate his passion
                into a set that resonates far beyond the cellar walls.
              </div>
            </div>
            ...
            <div className="flex flex-col gap-8 md:flex-row">
              ...
              />
              <div className="text-xl">
                Rhaegal is heading into a packed June, with shows lined up every
                weekend, and he&apos;s more than ready for it. He&apos;s been
                preparing for this moment, promising to deliver something fresh
                and out of the ordinary at every stop. Even with multiple
                appearances, expect no repetition—just pure, evolving energy.
                One of our own and one of the best, Bobi&apos;s about to remind
                us exactly where the kick hits hardest.
              </div>
            </div>
