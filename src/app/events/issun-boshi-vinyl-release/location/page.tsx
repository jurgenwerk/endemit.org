  ...
  return (
    <div className="m-auto max-w-5xl space-y-6 p-5 font-typo">
      ...
      <p className="text-xl font-light">
        The event will be held at Kader, Grad Kodeljevo,  <Link className={"link text-issun-boshi-yellow"} target={"_blank"} href={"https://www.google.com/maps/place/Kader+grad+Kodeljevo/@46.0452138,14.5450977,694a,35y,291.35h,63.48t/data=!3m1!1e3!4m6!3m5!1s0x47652d17cb626b19:0x79adf6a1b99302d9!8m2!3d46.0502643!4d14.5309968!16s%2Fg%2F11wc9x53n3?hl=en&entry=ttu&g_ep=EgoyMDI1MDgyNS4wIKXMDSoASAFQAw%3D%3D"}>Ul. Carla Benza 20 Ljubljana, Slovenija</Link>,
